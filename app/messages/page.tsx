      ...
      <div style={{ padding: "52px 16px 16px" }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{
            ...
            color: "var(--ghost)", letterSpacing: "0.12em", marginBottom: 4,
          }}>señales privadas</div>
            ...
            return (
              <button key={thread.id} onClick={() => onSelect(thread)} style={{
                ...
                <div style={{
                  ...
                  fontSize: isSystem ? 18 : 14, color,
                  background: `${color}10`, flexShrink: 0,
                }}>
                  {isSystem ? "·" : isObserver ? "?" : name[0]}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {thread.unread > 0 && (
                        <div style={{
                          ...
                          fontSize: 9, color: "#08080d", fontWeight: 600,
                        }}>
                          {thread.unread}
                        </div>
                      )}
                  ...
                  <p style={{
                    ...
                    fontSize: 12, color: "var(--ghost)", lineHeight: 1.4,
      ...
      <div style={{ padding: "16px 16px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24, paddingTop: 8 }}>
          ...
          <div style={{
            ...
            border: `1px solid ${color}40`,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: isSystem ? 16 : 13, color, background: `${color}10`,
          }}>
            {isSystem ? "·" : isObserver ? "?" : name[0]}
          </div>
          <div>
          ...
          {thread.messages.map((msg) => (
            <div key={msg.id} style={{
              ...
              <span style={{
                ...
                color: "var(--whisper)", marginTop: 6, textAlign: "right",
              }}>
                {msg.time}
              </span>
            </div>
